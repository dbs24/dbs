...
import org.dbs.goods.client.CreatedUserPassword as ENT
import org.dbs.goods.client.UpdateUserPasswordRequest as REQ

object GrpcUpdateUserPassword {

    suspend fun GoodsGrpcService.updateUserPasswordInternal(
        request: REQ,
        ...
        buildGrpcResponse {
            ResponseCoProcessorWrapper(object : ResponseCoProcessor<REQ, ENT.Builder> {
                ...
                private val user by lazy { LateInitVal<User>("goods") }
