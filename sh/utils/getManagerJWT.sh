...
#script require export variable $MANAGER_USER"
#script require export variable $MANAGER_PASSWORD"
#script require export variable $URI"

URI_ENDPOINT="/api/smart-safe-school-store/manager/v1/login"
PORT="1443"
TMPFILE=~/.$MANAGER_USER.jwt
...
curl -X 'POST' \
  ...
  \"entityAction\": {},
  \"entityInfo\": {
    \"userLogin\": \"$MANAGER_USER\",
    \"userPass\": \"$MANAGER_PASSWORD\",
