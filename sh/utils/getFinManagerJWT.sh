...
#script require export variable $FIN_MANAGER_USER"
#script require export variable $FIN_MANAGER_PASSWORD"
#script require export variable $URI"

URI_ENDPOINT="/api/banking-core/manager/v1/login"
PORT="1443"
TMPFILE=~/.$FIN_MANAGER_USER.jwt
...
curl -X 'POST' \
  ...
  \"entityAction\": {},
  \"requestBodyDto\": {
    \"userLogin\": \"$FIN_MANAGER_USER\",
    \"userPass\": \"$FIN_MANAGER_PASSWORD\"
  }
}" >$TMPFILE
