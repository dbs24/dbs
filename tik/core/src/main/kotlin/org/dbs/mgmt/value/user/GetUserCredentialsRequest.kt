...
import org.dbs.customer.UsersConsts.CmQueryParams.QP_USER_LOGIN
import org.springframework.web.reactive.function.server.ServerRequest
import org.dbs.mgmt.service.grpc.h1.convert.UserCredentialsConverter as H1_CONV
import org.dbs.customer.dto.customer.GetUserCredentialsResponse as H1_RESP
import org.dbs.customer.dto.customer.UserAuthDto as H1_DTO
    ...
    override suspend fun buildResponse(
        ...
        processor.createResponse(this, H1_RESP::class) {
            restFulService.buildMonoResponse(this) {
                ...
                { with(mgmtGrpcService) { getUserCredentialsInternal(it, ip()) } }
            }
        }
    }
}
