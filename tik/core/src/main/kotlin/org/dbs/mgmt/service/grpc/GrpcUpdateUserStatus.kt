...
import org.dbs.customer.UserCore.UserActionEnum.EA_UPDATE_USER_STATUS
...
import org.dbs.mgmt.client.CreatedUserStatus as ENT
import org.dbs.mgmt.client.UpdateUserStatusRequest as REQ
import org.dbs.protobuf.core.MainResponse as RESP

object GrpcUpdateUserStatus {

    suspend fun MgmtGrpcService.updateUserStatusInternal(
        request: REQ,
