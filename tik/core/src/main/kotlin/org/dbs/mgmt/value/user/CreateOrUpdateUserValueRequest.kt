...
import org.dbs.mgmt.service.grpc.h1.convert.CreateOrUpdateUserConverter as H1_CONV
import org.dbs.customer.dto.customer.CreateOrUpdateUserDto as DTO
import org.dbs.customer.dto.customer.CreateOrUpdateUserRequest as H1_REQ
import org.dbs.customer.dto.customer.CreateUserResponse as H1_RES
import org.dbs.customer.dto.customer.CreatedUserDto as OUT_DTO
        ...
        serverRequest,
            ...
            serverRequest.run {
                restFulService.buildMonoResponse(this, H1_REQ::class)
                {
                    ...
                    { with(mgmtGrpcService) { createOrUpdateUserInternal(it, ip()) } }
                }
            }
        }
}
