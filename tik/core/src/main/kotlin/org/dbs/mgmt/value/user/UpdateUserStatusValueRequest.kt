...
import org.dbs.mgmt.service.grpc.h1.convert.UpdateUserStatusConverter as H1_CONV
import org.dbs.customer.dto.customer.CreatedUserStatusDto as OUT_DTO
import org.dbs.customer.dto.customer.UpdateUserStatusDto as DTO
import org.dbs.customer.dto.customer.UpdateUserStatusRequest as H1_REQ
import org.dbs.customer.dto.customer.UpdateUserStatusResponse as H1_RES
    ...
    override suspend fun buildResponse(
        ...
        serverRequest.run {
            restFulService.buildMonoResponse(this, H1_REQ::class)
            {
                ...
                { with(mgmtGrpcService) { updateUserStatusInternal(it, ip()) } }
            }
        }
    }
}
