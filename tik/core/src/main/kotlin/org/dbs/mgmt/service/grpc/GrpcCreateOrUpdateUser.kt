...
import org.dbs.mgmt.service.grpc.GrpcCreateOrUpdateUser.JobKeyImp.JK_FIND_OR_CREATE_USER
...
import org.dbs.mgmt.client.CreateOrUpdateUserRequest as REQ
import org.dbs.mgmt.client.CreatedUserDto as ENT
    ...
    suspend fun MgmtGrpcService.createOrUpdateUserInternal(
        ...
        buildGrpcResponse {
            ResponseCoProcessorWrapper(object : ResponseCoProcessor<REQ, ENT.Builder> {
                ...
                ////////////////////////////////////////////////////////////////////////////////////////////////////////
                private val user by lazy { LateInitVal<User>("player") }
                private val user4Update by lazy { LateInitVal<User>("player4update") }
                ...
                override fun isValidDto() = request.run dto@{
                    with(rab) {
                        ...
                        oldUserLogin?.let {
                            ...
                            validateMandatoryField(playerPwd, PASSWORD_PATTERN, SSS_USER_PASSWORD)
                        } ?: addErrorInfo(
