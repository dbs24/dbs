...
import org.dbs.mgmt.TikMgmtApplication
import org.dbs.mgmt.config.TikMgmtConfig
...
@SpringBootTest(
    ...
    classes = [TikMgmtApplication::class]
)
@Import(TikMgmtConfig::class)
@TestInstance(PER_CLASS)
@TestMethodOrder(OrderAnnotation::class)
@AutoConfigureWebTestClient
abstract class AbstractChessTest(chessCoreKoTest: ChessKoTest) : AbstractKoTestBehaviorSpec() {
    init {
    ...
    val userServiceImpl by lazy { findService(UserServiceImpl::class) }
