...
class MailServerTestContainer : AbstractTestContainer2() {

    @Suppress(UNCHECKED_CAST)
    override fun <T : GenericContainer<*>> createContainer(): T =
        getProperty(USER_DIR).also { logger.debug { "user.dir = '$it'" } }
            .let {
                val workDir = "/home/user/Projects/uonmap/sss_services/3s-mail/mail-service"
                ...
                GenericContainer(imageName)
                    ...
                    .withEnv(
                        ...
                        "kafka.local.smartsafeschool.com:9092"
                    )
                    .withExposedPorts(port)
                    .withAccessToHost(true)
                    .withNetworkAliases("test.smartsafeschool.com")
