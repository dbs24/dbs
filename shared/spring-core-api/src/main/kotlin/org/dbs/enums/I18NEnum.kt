...
enum class I18NEnum(
    ...
    * */
    ...
    FLD_INVALID_OLD_USER_PASSWORD("Invalid old user password"),
    FLD_INVALID_OLD_AND_NEW_USER_PASSWORD("Old and new user passwords are equals"),
    ...
    UNKNOWN_ENTITY_STATUS("UNKNOWN ENTITY STATUS ({0})"),
