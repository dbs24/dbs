...
enum class Error(private val value: String, private val code: Int) : RefEnum {
    ...
    INVALID_OLD_ENTITY_PASSWORD("entity.old.password.invalid", 21),
    INVALID_ENTITY_PASSWORD("entity.password.invalid", 22),
    INVALID_ENTITY_OLD_AND_NEW_PASSWORD("entity.password.oldpassword.invalid", 23),
    UNKNOWN_ENTITY_STATUS("entity.status.unknown", 24),
    ...
    USER_DOES_NOT_EXISTS("unknown user", 200105),
