...
import org.dbs.cm.client.PlayerCredentials as H2E
import org.dbs.cm.client.PlayerCredentialsRequest as H2IN
import org.dbs.cm.client.PlayerCredentialsResponse as H2OUT
...
@JvmInline
value class PlayerCredentialsConverter(override val entClass: Class<H2E>) : H1h2<H1IN, H2IN, H1OUT, H2OUT, H1E, H2E> {
