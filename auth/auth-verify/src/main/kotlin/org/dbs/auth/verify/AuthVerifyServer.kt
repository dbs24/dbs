...
import org.dbs.auth.verify.consts.AuthVerifyConsts.AUTH_VERIFY_SET
...
class AuthVerifyServer : AbstractSpringBootApplication() {
    ...
    companion object {
        ...
        { WEB_SET + KAFKA_SET + JWT_SET + GRPC_AUTH_SERVER_CLIENT_SET + CORS_CONFIG_SET + GRPC_SET + AUTH_VERIFY_SET }
    }
}
