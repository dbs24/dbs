...
import org.dbs.protobuf.auth.UserLoginRequest as H2IN
...
@JvmInline
value class UserLoginConverter(override val entClass: KClass<H2E>) : H1h2<H1IN, H2IN, H1OUT, H2OUT, H1E, H2E> {
