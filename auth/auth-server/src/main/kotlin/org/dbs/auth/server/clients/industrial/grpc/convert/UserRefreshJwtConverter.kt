package org.dbs.auth.server.clients.industrial.grpc.convert

import org.dbs.grpc.api.H1h2
import org.dbs.grpc.api.H2H1
import kotlin.reflect.KClass
import org.dbs.protobuf.auth.RefreshUserJwtRequest as H2IN
...
@JvmInline
value class UserRefreshJwtConverter(override val entClass: KClass<H2E>) : H1h2<H1IN, H2IN, H1OUT, H2OUT, H1E, H2E> {
