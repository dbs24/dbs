...
import dsl.Dependencies.Projects.CC_SANDBOX_GRPC_CLIENT
...
val mainApplicationClassName = "org.dbs.sandbox.SandBoxApplication"
...
dependencies {
    ...
    testImplementation(project(CC_SANDBOX_GRPC_CLIENT))
