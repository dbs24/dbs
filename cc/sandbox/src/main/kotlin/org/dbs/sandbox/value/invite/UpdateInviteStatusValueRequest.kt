...
import org.dbs.invite.dto.invite.CreatedInviteStatusDto as OUT_DTO
import org.dbs.invite.dto.invite.UpdateInviteStatusDto as DTO
import org.dbs.invite.dto.invite.UpdateInviteStatusRequest as H1_REQ
import org.dbs.invite.dto.invite.UpdateInviteStatusResponse as H1_RES
import org.dbs.sandbox.service.grpc.h1.convert.UpdateInviteStatusConverter as H1_CONV

@JvmInline
value class UpdateInviteStatusValueRequest<R : ServerRequest>(private val serverRequest: R) :
    ...
    override suspend fun buildResponse(
        ...
        serverRequest.run {
            restFulService.buildMonoResponse(this, H1_REQ::class)
            {
                ...
                { with(sandBoxGrpcService) { updateInviteStatusInternal(it, ip()) } }
            }
        }
    }
}
