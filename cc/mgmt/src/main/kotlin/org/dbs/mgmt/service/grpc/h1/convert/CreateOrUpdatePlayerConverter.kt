...
import org.dbs.mgmt.client.CreateOrUpdatePlayerRequest as H2IN
import org.dbs.protobuf.core.MainResponse as H2OUT
import org.dbs.mgmt.client.CreatedPlayerDto as H2E
...
@JvmInline
value class CreateOrUpdatePlayerConverter(override val entClass: KClass<H2E>) :
    ...
    override fun buildEntityH1(h2: H2E): H1E = h2.run { H1E(playerLogin, email, status) }
