...
import org.dbs.mgmt.client.CreatedPlayerStatus as H2E
import org.dbs.mgmt.client.UpdatePlayerStatusRequest as H2IN
...
@JvmInline
value class UpdatePlayerStatusConverter(override val entClass: KClass<H2E>) :
