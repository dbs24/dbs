...
import org.dbs.mgmt.service.grpc.h1.convert.UpdatePlayerPasswordConverter as H1_CONV
import org.dbs.player.dto.player.CreatedPlayerPasswordDto as OUT_DTO
import org.dbs.player.dto.player.UpdatePlayerPasswordDto as DTO
import org.dbs.player.dto.player.UpdatePlayerPasswordRequest as H1_REQ
import org.dbs.player.dto.player.UpdatePlayerPasswordResponse as H1_RES

@JvmInline
value class UpdatePlayerPasswordValueRequest<R : ServerRequest>(private val serverRequest: R) :
    GenericRequest<R>,
    ...
    override suspend fun buildResponse(
        ...
        restFulService.buildMonoResponse(this, H1_REQ::class)
        {
            ...
            {  with(mgmtGrpcService) { updatePlayerPasswordInternal(it, ip()) } }
        }
    } }
}
